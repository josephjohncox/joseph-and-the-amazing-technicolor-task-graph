...
use coat_domain::{
    ...
    ChildTaskRequest, ChildTaskRequestChannel, ControlLoopPolicy, DeviceAuthProvider, DurablePlan,
    ...
    GoalStoreGoalResponse, GoalStorePolicy, GoalStoreProjectionMode, GoalStoreSnapshot,
    GoalStoreSnapshotUpsertRequest, GoalStoreSnapshotUpsertResponse, GoalStoreTaskListResponse,
    GoalTriggerTemplate, HumanApproval, HumanFeedback, InformationUsePlan, LearningSignal,
    McpAccessMode, McpAuthRef, McpContextRef, MemoryAdapterReport, MemoryContextRequest,
    MemoryContextResponse, MemoryEpisode, MemoryEvent, MemoryJoinRequest, MemoryJoinResponse,
    MemoryPolicy, MemoryRepairRequest, MemoryRepairResponse, MemoryRetrievalPolicy,
    MemorySearchRequest, MemorySearchResponse, MemoryStoreRef, MemoryWriteRequest,
    MemoryWriteResponse, MissedRunPolicy, ModelRoute, NativeSubagentSpawnPolicy,
