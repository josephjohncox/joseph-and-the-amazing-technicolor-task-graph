...
- Add domain contracts for event sources, generic JSON sources, webhooks, schedules, calendars, routes, external events, and triggered goals.
...
- Document how generic events, webhooks, calendars, cron, and event buses interact with Restate.
